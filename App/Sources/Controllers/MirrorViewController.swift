...
class MirrorViewController: UIViewController {
    ...
    private func loadTools() {
        let tools = ToolData.tools(for: .mirror)
        createToolGrid(tools: tools, in: contentView, title: "Before/After & Comparison")
    }
    
    private func createToolGrid(tools: [Tool], in container: UIView, title: String) {
